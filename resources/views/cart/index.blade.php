@extends('partials.app')@section('seo_title','Корзина')@section('meta_keywords','Корзина')@section('meta_description','Корзина')@section('content')
...
{{--                <form action="#" method="post" enctype="multipart/form-data">--}}
                    <div class="row align-items-center cartRow mb-md-3 mb-xl-5" data-ng-repeat="product in cart.products">
                        ...
                        <div class="col-9 col-sm-10 col-md px-3 px-lg-5 cartProductItem">
                            <div>
{{--                                <p class="article">Артикул: <span>1</span></p>--}}
