...
class ProductsController extends Controller
{
    public function show($subcatSlug,$productSlug)
    {
        ...
        $compare = app('compare');
        $productT = Product::whereSlug($productSlug)->first();
        ...
        $newProducts = Product::where('is_new', true)->take(10)->get();
        $saleProducts = Product::whereNotNull('sale_price')->orWhere('sale_price' ,'>',0)->take(10)->get();

        return view('products.show',compact('product','productT','featuredProducts', 'newProducts','saleProducts','locale','fallbackLocale'));
    }
