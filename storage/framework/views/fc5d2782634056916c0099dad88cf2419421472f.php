            ...
            <div id="quickcheckout-disable" class="row">
                ...
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 offset-xl-0 col-xl-6  order-first order-xl-last pl-xl-4 pt-4">
                    <div class="mb-4 mb-sm-5 sectionStatus">
                        <form action="<?php echo e(route('cart.checkout.submit')); ?>" method="POST">
...
<?php echo $__env->make('partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/b/buldoorskz/domains/buldoors.kz/resources/views/cart/checkout.blade.php ENDPATH**/ ?>