...
<?php $__env->startSection('seo_title',$category->seo_title); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-12 mb-1 d-none d-sm-block">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><a href="#"><?php echo e($category->name); ?></a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                        <h1 class="m-0"><?php echo e($category->name); ?></h1>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/b/buldoorskz/domains/buldoors.kz/resources/views/products/index.blade.php ENDPATH**/ ?>