...
class ControllerMailOrder extends Controller {
	...
	public function alert(&$route, &$args) {
		...
		if ($order_info && !$order_info['order_status_id'] && $order_status_id && in_array('order', (array)$this->config->get('config_mail_alert'))) {	
            ...
            $data['payment'] = $order_info['payment_method'];
            $data['shipping'] = $order_info['shipping_method'];
            //$data['address'] = $order_info['payment_custom_field'][3];
            //$data['float'] = $order_info['payment_custom_field'][5];
            //$data['date'] = $order_info['payment_custom_field'][6];
            //$data['time'] = $order_info['payment_custom_field'][7];
            $data['comments'] = $order_info['payment_custom_field'][4];
