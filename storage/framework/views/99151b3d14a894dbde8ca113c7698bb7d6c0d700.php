                                        ...
                                        <div class="sliders-box">
                                            <div class="slide"
                                                 style="position: absolute; top: 0px; left: 0px; display: block;"><img
                                                    src="/images/main-slider.jpeg" alt="Main slider"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="title">
                                        <hgroup>
                                            <h1 class="text-center text-lg-left"
                                                style="font-size:36px;color:#FFF;font-weight:500">Поздравляем с днем
                                                единства народов и дарим скидку до 30%</h1>
                                        </hgroup>
                    ...
                    <div class="container py-3 py-xl-5">
                        <div class="row">
                            <div class="col-lg-5 order-last order-lg-first">
                                <div class="row">
                                    <div class="col-sm-6 col-lg-5 p-3"><img src="img/1.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="col-sm-6 col-lg-7 p-3"><img src="img/2.png" class="img-fluid" alt="">
                                    </div>
                    ...
                    <div class="container py-3 py-xl-5">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 p-3 text-center">
                                <img src="img/whyItem.png" alt="" class="d-block mb-3 w-100" height="277">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 p-3 text-center">
                                <img src="img/whyImg2.png" alt="" class="d-block mb-3 w-100" height="277">
                            ...
                            <div class="col-xl-3 col-lg-4 offset-md-3 offset-lg-0 col-md-6 p-3 text-center">
                                <img src="img/whyImg3.png" alt="" class="d-block mb-3 w-100" height="277">
                                        ...
                                        <div class="col-12 commentItem">
                                            <div class="row align-items-center">
                                                <div class="col-auto"><img
                                                        ...
                                                        alt="" class="rounded-circle w-100 h-100"></div>
                                                <div class="col">
                            ...
                            <div class="modal-body">
                                <div class="allComments owl-carousel">
                                    <div class="commentItems">
                                        <div class="row align-items-center">
                                            <div class="col-auto"><img src="/storage/catalog/avaComment-100x100.png" alt="" class="rounded-circle w-100 h-100"></div>
                                            <div class="col">
                                                <strong class="d-block">Жумабеков Аскар</strong>
                                                <span class="d-block">г. Талгар, Алматинская область.</span>
                                            </div>
                        ...
                        <div class="row">
                            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-xl-3 py-3 col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                    <div class="newsItem">
                                        <img src="<?php echo e(Storage::disk('public')->url($post->image)); ?>" alt="новость"
                                             class="d-block">
                                        <div class="p-3 newsCaption">
                                            <time class="d-block mb-3"><?php echo e($post->created_at); ?></time>
                                            <p class="mb-3"><strong><?php echo e($post->title); ?></strong></p>
                                            <p class="mb-3 d-block"><?php echo e($post->excerpt); ?></p>
                                            <a href="/news/<?php echo e($post->slug); ?>" class="moreNews">Подробнее</a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/0/004/domains/buldoors.testkz.ru/resources/views/home.blade.php ENDPATH**/ ?>