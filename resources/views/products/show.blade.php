...
@section('content')
    <div id="product-product" class="" data-ng-controller="ProductController as pc">
        ...
        <section id="productPage" class=" py-5" data-ng-init="pc.init('{{$product->slug}}')">
            <div class="container">
                <div class="row">
                    @if($product->images &&
                        ...
                        <div class="interior">
                            ...
                            <div class="interiorContent">
                                <div class="productImage"><img id="interiorImg" class="product"
                                                               src="{{Voyager::image(json_decode($product->images)[0])}}"
                        ...
                        <div class="row">
                            <div class="mb-4 mb-md-0 offset-sm-2 offset-md-0 col-sm-8 col-md-6 col-lg-4">
                                <div class="productImg mb-4">
                                    <img src="{{ Voyager::image($product->thumb) }}" alt="{{$product->name}}">
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="productAttr">
                                    <div class="row mb-4 px-md-4">
                                        ...
                                        <div class="col-lg-6 mb-3 mb-lg-0 text-center text-lg-right">
                                            <span class="prodInstock mr-2 {{ !$product->stock_count ? 'text-danger' : '' }}">{{ $product->stock_count ? 'Есть в наличии' : 'На заказ' }}</span>

{{--                                            <span class="article ml-2">Артикул: <span></span></span>--}}
                                        </div>
                                    </div>

                                    <div id="product">
                                        @if($productT->options->count())
                                        <div class="d-flex flex-column flex-lg-row justify-content-between px-4 pb-4">
                                            @foreach($productT->options()->distinct('option')->pluck('option') as $option)
                                                <div class="text-center required ">
                                                    <label class="control-label mb-3">{{ $option }}:
                                                        <span></span></label>
                                                    <div id="input-option{{\Illuminate\Support\Str::slug($option)}}">
                                                        <div class="radio">
                                                            @foreach($productT->options()->where('option', $option)->get() as $optionValue)
                                                            <label data-option="{{ $optionValue->value }}" class="active">
                                                                <span></span>
                                                                <input type="radio" name="option[{{\Illuminate\Support\Str::slug($option)}}]" value="{{ $optionValue->id }}">
                                                            </label>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row align-items-center px-md-4 mb-5">
                                            <div class="col-sm-6 col-md-12 col-xl-6 mb-4 mb-sm-0 mb-md-4 mb-xl-0">
                                                <span class="prodPrice float-left">{{number_format($product->regular_price,0 ,'', ' ')}} <span>₸</span></span>
                                                {{--<div class="prodQty float-right">

                                                    <button id="minus" class="minus btnCount" data-ng-click="cart.removeQuantity(product)"></button>
                                                    <input name="quantity" id="input-quantity" class="countProduct" type="text" readonly="" data-ng-value="@{{product.quantity}}" data-ng-model="product.quantity">
                                                    <button id="plus" class="plus btnCount" data-ng-click="cart.addQuantity(product)"></button>
                                                </div>--}}
...
{{--                                                            data-ng-if="!pc.inCart"--}}
                                                        ...
                                                        <button
                                                            ...
                                                            data-ng-click="pc.addToCompare({{$product->id}})"
                                                        >
                                                        ...
                                                        <button
                                                            class="prodBtnComp d-none d-lg-inline"
                                                            data-ng-if="pc.product.inCompare"
                                                            data-ng-click="pc.deleteCompare({{$product->id}})"
                                                        >
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="tab-content productCharCont" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade active show" id="mainCharacter" role="tabpanel" aria-labelledby="nav-home-tab">
                                                    <ul class="list-unstyled">
                                                        @foreach($productT->chars as $char)
                                                        <li class="px-4 py-3">
                                                            <div class="row align-items-center">
                                                                <div class="col-5">
                                                                    <p class="leftChar">{{$char['name']}}:</p>
                                                                </div>
                                                                <div class="col-7">
                                                                    <p class="rightChar">{{$char['value']}}</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        @endforeach
