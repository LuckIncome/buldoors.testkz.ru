...
class CategoriesController extends Controller
{
    public function catalog()
    {
        ...
        $featuredProducts = Product::where('featured', true)->get()->take(12);
//        $featuredProducts = $featuredProducts->translate($locale,$fallbackLocale);

        $newProducts = Product::where('is_new', true)->get()->take(12);
...
//        $saleProducts = $saleProducts->translate($locale,$fallbackLocale);
        ...
        $catalog = Category::whereNull('parent_id')->where('id', '<', 17)->orderBy('order')->get();
