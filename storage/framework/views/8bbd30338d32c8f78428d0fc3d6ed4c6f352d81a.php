                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="pull-right col-md-6">
                                <form action="<?php echo e(route('orders.export')); ?>" method="post">
                                                    ...
                                                    <?php elseif($row->field == 'status'): ?>
                                                        <?php
                                                            switch ($data->{$row->field}){
                                                                case 0: $dataStatus = 'Новый заказ';break;
                                                                case 1: $dataStatus = 'Выполняется';break;
                                                                case 2: $dataStatus = 'Выполнен';break;
                                                                case 3: $dataStatus = 'Отменен';break;
                                                                case 4: $dataStatus = 'Возврат';break;
                                                                default: $dataStatus = 'Неопределен';break;
                                                            }
                                                        ?>
                                                        <div class="readmore"><?php echo e($dataStatus); ?></div>
                                                    <?php elseif($row->field == 'delivery_type'): ?>
                                                        <div class="readmore"><?php echo e(($data->{$row->field} == 'self') ? 'Самовывоз' : 'Доставка'); ?></div>
                                                    <?php elseif($row->field == 'payment_type'): ?>
                                                        <div class="readmore"><?php echo e(($data->{$row->field} == 'cash') ? 'Наличными' : 'Картой(оплачен)'); ?></div>
                                                    <?php else: ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/b/buldoorskz/domains/buldoors.kz/resources/views/vendor/voyager/orders/browse.blade.php ENDPATH**/ ?>